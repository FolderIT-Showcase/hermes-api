...
namespace Protosofia\Ben10ant\Facades { 
    ...
    class TenantFacade {
        ...
        {
            return \App\Providers\MyDefaultTenantService::setTenant($tenant);
        }
         ...
         * @static 
         */ 
        public static function setTenantByID($id)
        {
            //Method inherited from \Protosofia\Ben10ant\Contracts\TenantServiceAbstract            
            return \App\Providers\MyDefaultTenantService::setTenantByID($id);
        }
         ...
         * @static 
         */ 
        public static function setTenantByUUID($uuid)
        {
            //Method inherited from \Protosofia\Ben10ant\Contracts\TenantServiceAbstract            
            return \App\Providers\MyDefaultTenantService::setTenantByUUID($uuid);
        }
         ...
         * @static 
         */ 
        public static function setTenantByKey($key)
        {
            //Method inherited from \Protosofia\Ben10ant\Contracts\TenantServiceAbstract            
            return \App\Providers\MyDefaultTenantService::setTenantByKey($key);
        }
        ...
        {
            //Method inherited from \Protosofia\Ben10ant\Contracts\TenantServiceAbstract            
            return \App\Providers\MyDefaultTenantService::new($params);
        }
        ...
        {
            //Method inherited from \Protosofia\Ben10ant\Contracts\TenantServiceAbstract            
            return \App\Providers\MyDefaultTenantService::hello();
        }
